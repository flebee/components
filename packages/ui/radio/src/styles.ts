...
export const wrapper = cva({
  base: 'relative inline-flex items-center justify-center flex-shrink-0 border-solid border-2 border-neutral-500 rounded-full group-has-[:checked]:border-primary transition-colors ease-linear duration-200 motion-reduce:transition-none peer-enabled:peer-hover:bg-primary/40',
  variants: {
    size: {
      sm: 'size-4',
      md: 'size-5',
